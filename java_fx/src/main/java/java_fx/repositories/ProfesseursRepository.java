...
public class ProfesseursRepository extends Mysql implements IProfesseurRepository{
    ...
    private static final String SQL_INSERT_AFFECT="insert into prof_classe(idclasse,idprof) values(?,?)";
    ...
    public void affecterClasseProfesseur(Utilisateurs professeur, Classe classe) {
        ...
        this.ouvertureConnexion();
        try {
            ps=conn.prepareStatement(SQL_INSERT_AFFECT,PreparedStatement.RETURN_GENERATED_KEYS);
